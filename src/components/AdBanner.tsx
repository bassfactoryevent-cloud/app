...
export default async function AdBanner({ placementName, className = "" }: AdBannerProps) {
  ...
  const content = (
    <div className={className} style={{ position: 'relative', width: '100%', borderRadius: '0.5rem', overflow: 'hidden', display: 'flex' }}>
      <img src={ad.image_url} alt="Ad Banner" style={{ width: '100%', height: 'auto', objectFit: 'cover' }} />
